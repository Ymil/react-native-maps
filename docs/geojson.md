...
| `lineCap`           | `'butt'`, `'round'`, `'square'`         | `'butt'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | The line cap style to apply to the open ends of the path. Possible values are `butt`, `round`, or `square`. Note: lineCap is not yet supported for Google Maps provider on iOS. |
| `lineJoin`          | `'miter'`, `'round'`, `'bevel'`        | `'miter'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | The line join style to apply to corners of the path. Possible values are `miter`, `round`, or `bevel`.                                                                         |
